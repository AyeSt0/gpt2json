...
| 来源 | 支持状态 | 说明 |
| --- | --- | --- |
| [号商格式](https://pay.ldxp.cn/shop/plus7) | ✅ 已支持 | 仅适配该页面交付的账号文本格式 |

当前版本只对上面这个号商页面交付的账号格式做了适配；其它来源、其它字段顺序或其它取码方式暂不保证可识别。
...
> 后续格式适配敬请期待：实际适配顺序以号商提供的账号文本、取码链接、邮箱凭据或令牌字段为准。
