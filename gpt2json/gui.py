...
class MainWindow(QMainWindow):
    ...
    def _backend_display(self, value: Any) -> str:
        mapping = {
            ...
            "command": "本地命令",
            "imap": "号商邮箱取码（待适配）",
            "imap_xoauth2": "号商邮箱令牌取码（待适配）",
            "graph": "号商邮箱令牌取码（待适配）",
            "jmap": "号商邮箱取码（待适配）",
            "pop3": "号商邮箱取码（待适配）",
            "api": "号商自定义取码（待适配）",
            "json": "JSON 接口",
            "html_api_json": "HTML 自动发现取码接口(JSON)",
            "html_api_text": "HTML 自动发现取码接口(Text)",
            "html": "HTML 页面",
            "text": "文本页面",
        }
